...
export const WS_CONNECT_ERROR = WebSocketEvent.CONNECT_ERROR
...
export const WS_RECONNECT_DELAY_MAX = 30_000

// Dashboards are long-lived displays, so never stop retrying: a bounded count
// leaves the dashboard permanently dead after an outage until a manual refresh.
export const WS_RECONNECT_ATTEMPTS = Infinity

// Grace period before telling the user a disconnect happened, so brief blips
// and server restarts stay silent.
export const WS_DISCONNECT_NOTIFY_DELAY = 3_000
