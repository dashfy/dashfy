...
A dashboard built with [Dashfy](https://github.com/dashfy/dashfy), scaffolded from the `react-router-app` template (GitHub, System, and Market Live extensions included).
...
- `pnpm build` emits the SPA into `build/client`, which the server serves via the
